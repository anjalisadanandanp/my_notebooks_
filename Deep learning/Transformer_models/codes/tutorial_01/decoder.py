...
dencoder = DecoderLayer(d_model=512, n_head=8, d_ff=2048, dropout=0)
print(dencoder)
#test forward
x = torch.zeros((5, 20, 512))
encoder_out = torch.zeros((5, 20, 512)) 
src_mask = torch.zeros((5, 1, 1, 20))
tgt_mask = torch.zeros((5, 1, 20, 20))
x = dencoder(x, encoder_out, src_mask, tgt_mask)
print(x.shape)